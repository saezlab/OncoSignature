...
# 
# Considering four drug-treated cell-lines grouped as responders and non-responders, here we will compute the KSEA for the following contrasts between groups:
# - GDM1.2 vs. GDM1.1: effect of treatment in GDM1 cell-line
# - PL21.2 vs. PL21.1: effect of treatment in PL21 cell-line
# - NOMO1.2 vs. NOMO1.1: effect of treatment in NOMO1 cell-line
# - MV411.2 vs. MV411.1: effect of treatment in MV411 cell-line
# - R.2 vs. R.1: effect of treatment in responders
# - NR.2 vs. NR.1: effect of treatment in non-responders
# - R.1 vs. NR.1: difference between responders and non-responders prior to treatment
